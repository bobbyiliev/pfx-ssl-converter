...
if (isset($_POST['cert'])) {
    ...
    if (file_exists("./tmp/$tempDir/$domain") && (filesize($theFile) != 0)) {
        ...
        echo "<div class='message' >Click here to download the SSL: <a class='download' href='https://ssl.bobbyiliev.com/tmp/$tempDir/$domain'> DOWNLOAD </a>  <br /> Hurry up! The file will be deleted in 59 seconds! </div>";
